# Instalación distribuida de SOC Operations 0.1.150
...
`$HOME/soc-installer/release-0.1.150` con 38 archivos y `SHA256SUMS` válido.
...
La salida debe incluir `installer_version=0.1.150`, `topology=distributed`, el `deployment_id`
