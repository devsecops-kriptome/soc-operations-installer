...
## 1. Alcance y estado en SOC Operations 0.1.145
...
Copie también el release `0.1.145` al Indexer. Suponga que el bundle individual quedó en
`/root/geoip-client`:
...
En `0.1.145` no existe todavía un interruptor en la interfaz web.
...
y controlar estos servicios, pero esa función no forma parte de `0.1.145`.
